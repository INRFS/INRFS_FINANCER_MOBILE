...
const styles = StyleSheet.create({
  ...
  navText: { color: colors.subtle, fontFamily: fonts.semibold, fontSize: 10 },
  active: { color: colors.purple },
  muted: { color: colors.muted, fontFamily: fonts.regular, fontSize: 11, lineHeight: 17 },
  ...
  sheetTitle: { color: colors.dark, fontFamily: fonts.bold, fontSize: 19 },
});
