...
function AuthShell({ children }: { children: React.ReactNode; scroll?: boolean }) {
  return <Screen contentStyle={styles.authScroll}><Card style={styles.authCard}>{children}</Card></Screen>;
}
