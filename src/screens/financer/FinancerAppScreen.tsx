...
const styles = StyleSheet.create({
  ...
  overlay: { flex: 1, backgroundColor: "rgba(6, 50, 56, 0.45)", justifyContent: "flex-end" }, menuSheet: { maxHeight: "92%", backgroundColor: colors.white, borderTopLeftRadius: radii.xxl, borderTopRightRadius: radii.xxl, padding: 18 }, sheetHandle: { width: 42, height: 4, borderRadius: 2, backgroundColor: colors.border, alignSelf: "center", marginBottom: 14 }, menuList: { paddingVertical: 16, gap: 4 }, menuRow: { minHeight: 45, borderRadius: radii.md, flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 13 }, menuRowActive: { backgroundColor: colors.cyanSoft }, menuLabel: { flex: 1, color: colors.muted, fontFamily: fonts.medium, fontSize: 13 }, menuBadge: { minWidth: 21, height: 21, borderRadius: 11, backgroundColor: colors.error, alignItems: "center", justifyContent: "center" }, menuBadgeText: { color: colors.white, fontFamily: fonts.bold, fontSize: 10 }, profileRow: { flexDirection: "row", alignItems: "center", gap: 10, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 15 },
  flowSheet: { maxHeight: "93%", backgroundColor: colors.white, borderTopLeftRadius: radii.xxl, borderTopRightRadius: radii.xxl }, sheetHeader: { minHeight: 58, borderBottomWidth: 1, borderBottomColor: colors.border, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 18 }, sheetTitle: { color: colors.dark, fontFamily: fonts.extrabold, fontSize: 18 }, flowBody: { padding: 18, paddingBottom: 35 }, progress: { flexDirection: "row", justifyContent: "space-between", position: "relative" }, progressDot: { width: 34, height: 34, borderRadius: 17, backgroundColor: colors.surfaceSoft, borderWidth: 2, borderColor: colors.border, alignItems: "center", justifyContent: "center" }, progressActive: { backgroundColor: colors.cyan, borderColor: colors.cyan }, progressText: { color: colors.muted, fontFamily: fonts.bold, fontSize: 12 }, formTitle: { color: colors.dark, fontFamily: fonts.extrabold, fontSize: 17 }, upload: { minHeight: 56, flexDirection: "row", alignItems: "center", gap: 11, borderWidth: 1, borderStyle: "dashed", borderColor: colors.border, borderRadius: radii.md, paddingHorizontal: 13 }, link: { marginLeft: "auto", color: colors.cyan, fontFamily: fonts.semibold, fontSize: 12 }, profileHero: { flexDirection: "row", alignItems: "center", gap: 13 }, largeAvatar: { width: 58, height: 58, borderRadius: 29, backgroundColor: colors.cyanSoft, alignItems: "center", justifyContent: "center" }, largeAvatarText: { color: colors.cyan, fontFamily: fonts.extrabold, fontSize: 18 }, frequency: { flexDirection: "row", gap: 8 }, freqCard: { flex: 1, height: 82, alignItems: "center", justifyContent: "center", gap: 7, borderWidth: 2, borderColor: colors.border, borderRadius: radii.md }, freqSelected: { borderColor: colors.cyan, backgroundColor: colors.cyanSoft }, freqText: { color: colors.muted, fontFamily: fonts.semibold, fontSize: 11 }, calcCard: { overflow: "hidden", paddingTop: 20 }, accentLine: { position: "absolute", left: 0, top: 0, right: 0, height: 4, backgroundColor: colors.cyan }, calcTotal: { alignItems: "center", paddingTop: 17 }, calcValue: { color: colors.cyan, fontFamily: fonts.extrabold, fontSize: 30, marginTop: 5 }, calcPeriod: { color: colors.cyanDark, fontFamily: fonts.bold, fontSize: 9, letterSpacing: 1 }, examples: { gap: 8 }, example: { borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, padding: 12 }, exampleValue: { color: colors.cyan, fontFamily: fonts.bold, fontSize: 14, marginTop: 4 }, summaryCard: { backgroundColor: colors.surfaceSoft }, message: { color: colors.dark, fontFamily: fonts.regular, fontSize: 13, lineHeight: 21 }, empty: { minHeight: 130, alignItems: "center", justifyContent: "center", gap: 8 },
});
